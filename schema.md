...
Satuan di atas (ppm/ppb/µg/m3) mengikuti satuan umum tiap sensor — perlu dicek ulang terhadap datasheet masing-masing sensor (SDS011, Winsen MH-Z19C [CO2, lihat `architecture.md` 2.1], SGP30, MiCS-4514) saat implementasi agar konsisten dengan output aktualnya.
