...
const ABOUT_ROWS = [
  {
    ...
    title: 'Proyek',
    body: 'Falhora – Faletehan Hospital Indoor Air Quality (Sistem Pemantauan Kualitas Udara Dalam Ruang Rumah Sakit)',
  },
  {
  ...
  },
  {
    ...
    title: 'Pengembang',
    body: 'Dede Brahma Rianto · Universitas Faletehan\nProgram Studi: Informatika',
  },
  {
    ...
    <SafeAreaView style={styles.screen} edges={['top']}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          ...
          <Text style={styles.heroTitle}>Falhora</Text>
          <Text style={styles.heroSubtitle}>Faletehan Hospital Indoor Air Quality</Text>
          <Text style={styles.heroBody}>
            Falhora adalah platform pemantauan lingkungan yang menggabungkan sensor IoT dan evaluasi berbasis aturan
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  scrollContent: { padding: 18, paddingTop: 28, paddingBottom: 28 },
  hero: { alignItems: 'center' },
  heroLogo: { width: 72, height: 72, borderRadius: radius.xl, overflow: 'hidden' },
